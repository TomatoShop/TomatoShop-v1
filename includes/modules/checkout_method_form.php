...
<div class="moduleBox" style="width: 49%; float: left;">
  ...
  <div class="content">
    ...
    <ul>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_email_address'), 'email_address') . '<br />' . osc_draw_input_field('email_address', $email_address,'dir="ltr"');?></li>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_password'), 'password') . '<br />' . osc_draw_password_field('password','dir="ltr"');?></li>
    </ul>
