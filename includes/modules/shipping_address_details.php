...
<div class="moduleBox">
  <div class="content">
    ...
    ?>    
      ...
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_street_address'), null, 'shipping_street_address', true) . osc_draw_textarea_field('shipping_street_address', $street_address,35,3); ?></li>
    ...
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_post_code'), null, 'shipping_postcode', (ACCOUNT_POST_CODE > 0)) . osc_draw_input_field('shipping_postcode', $postcode,'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    <?php
    ...
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_telephone_number'), null, 'shipping_telephone', (ACCOUNT_TELEPHONE > 0)) . osc_draw_input_field('shipping_telephone', $telephone,'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    ...
    <?php
      if (ACCOUNT_FAX > -1) {
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_fax_number'), null, 'shipping_fax', (ACCOUNT_FAX > 0)) . osc_draw_input_field('shipping_fax', $fax,'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    </div>
