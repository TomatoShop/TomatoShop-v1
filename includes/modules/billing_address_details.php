...
*/
  ...
  $ship_to_this_address = (isset($address['ship_to_this_address']) && $address['ship_to_this_address'] == '0') ? false : true;
...
<div class="moduleBox">
  <div class="content">
    ...
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('email_address'), null, 'billing_email_address', true) . osc_draw_input_field('billing_email_address', $email_address, 'dir="ltr"'); ?> </li>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_password'), null, 'billing_password', true) . osc_draw_password_field('billing_password','dir="ltr"'); ?></li>
      <li style="margin-bottom: 10px"><?php echo osc_draw_label($osC_Language->get('field_customer_password_confirmation'), null, 'billing_confirm_password', true) . osc_draw_password_field('billing_confirm_password','dir="ltr"'); ?></li>
    <?php
      }
    ?>
    ...
    ?>
    <li>
      <div style="float: left; padding: 0px 20px 10px 0px; text-align: center;">
        <?php echo '<b>' . $osC_Language->get('please_select') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_west_south.gif'); ?>
      </div>
    ...
    ?>
      ...
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_street_address'), null, 'billing_street_address', true) . osc_draw_textarea_field('billing_street_address', $street_address, 35, 3); ?></li>
    ...
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_post_code'), null, 'billing_postcode', (ACCOUNT_POST_CODE > 0)) . osc_draw_input_field('billing_postcode', $postcode, 'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    <?php
    ...
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_telephone_number'), null, 'billing_telephone', (ACCOUNT_TELEPHONE > 0)) . osc_draw_input_field('billing_telephone', $telephone, 'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    ...
    <?php
      if (ACCOUNT_FAX > -1) {
    ?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_fax_number'), null, 'billing_fax', (ACCOUNT_FAX > 0)) . osc_draw_input_field('billing_fax', $fax, 'dir="ltr"'); ?></li>
    <?php
      }
    ?>
    </div>
