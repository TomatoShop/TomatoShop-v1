...
*/
  ...
  class toC_Return_Slip_PDF {
    ...
    function render () {
      ...
      $this->_pdf->MultiCell(0, 4, $osC_Language->get('return_slip_heading_title'), 0, 'C');
      ...
      $this->_pdf->Cell(12, 6, '', 'TB', 0, 'C', 0);
      $this->_pdf->Cell(140, 6, $osC_Language->get('heading_products_name'), 'TB', 0, 'C', 0);
      $this->_pdf->Cell(24, 6,  $osC_Language->get('heading_products_quantity'), 'TB', 0, 'C', 0);
      $this->_pdf->Ln();
      ...
      $this->_pdf->Cell(176, 7, '', 'T', 0, 'C', 0);

      //Comments:
      $this->_pdf->ln();
      $this->_pdf->SetFont(TOC_PDF_FONT, 'B', TOC_PDF_FIELD_DATE_PURCHASE_FONT_SIZE);
      $this->_pdf->Cell(55, 4, $osC_Language->get('operation_heading_comments'), 0, 'R');
      $this->_pdf->ln();
      $this->_pdf->SetFont(TOC_PDF_FONT, '', TOC_PDF_FIELD_DATE_PURCHASE_FONT_SIZE);
      $this->_pdf->MultiCell(175, 4, $this->_order_return->getComment(), 0, 'R');
      
      $this->_pdf->ln(10);
      $this->_pdf->SetFont(TOC_PDF_FONT, 'B', TOC_PDF_FIELD_DATE_PURCHASE_FONT_SIZE);
      $this->_pdf->MultiCell(175, 4, $osC_Language->get('operation_heading_reminder'), '', 'R');

      $this->_pdf->ln();
      $this->_pdf->SetFont(TOC_PDF_FONT, '', TOC_PDF_FIELD_DATE_PURCHASE_FONT_SIZE);
      $this->_pdf->MultiCell(175, 4, str_replace('<br />', "\n", $osC_Language->get('return_slip_reminder')), 'LTRB', 'R');

      $this->_pdf->Output("Return Slip.pdf", "I");
    }
  }
?>