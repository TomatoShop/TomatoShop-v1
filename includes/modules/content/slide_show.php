      ...
      if ($Qimages->numberOfRows() > 0) {
        ...
        if(MODULE_CONTENT_SLIDE_SHOW_DISPLAY_INFO == 'True'){
          ...
          $info_css =
            ...
            '#slideInfo p{color:#fff;padding:3px 8px;font-family:Tahoma;font-size:12px;}' . "\n" .
            '#slideInfo a{float:left;background:#fff;color:#000;font-size:10px;margin:5px 5px;width:30px;text-decoration:none;text-align:center}' . "\n";
          $info_js  =
        ...
        $css = '#slideWrapper{position:relative; width:' . MODULE_CONTENT_SLIDE_SHOW_WIDTH . 'px; height:' . MODULE_CONTENT_SLIDE_SHOW_HEIGHT . 'px; overflow:hidden;}' . chr(13) .
               ...
               '#slideItems span{display:block; float:right;}' . chr(13) .
