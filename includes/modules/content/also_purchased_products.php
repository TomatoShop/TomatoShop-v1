...
/* Class constructor */
    ...
    function initialize() {
      ...
      if (isset($osC_Product)) {
        ...
        if ($Qorders->numberOfRows() >= MODULE_CONTENT_ALSO_PURCHASED_MIN_DISPLAY) {
          ...
          while ($Qorders->next()) {
            $this->_content .= '<span style="width: 33%; float: right; text-align: center;">';
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('حداقل موارد برای نمایش', 'MODULE_CONTENT_ALSO_PURCHASED_MIN_DISPLAY', '1', 'حداقل تعداد محصولات برای نمایش', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('حداکثر موارد برای نمایش', 'MODULE_CONTENT_ALSO_PURCHASED_MAX_DISPLAY', '6', 'حداکثر تعداد محصولات برای نمایش', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('کش محتویات', 'MODULE_CONTENT_ALSO_PURCHASED_PRODUCTS_CACHE', '60', 'تعداد دقایقی که محتویات در حافظه کش ذخیره شود (0 = ذخیره نشود)', '6', '0', now())");
    }
