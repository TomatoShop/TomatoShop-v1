...
/* Class constructor */
    ...
    function initialize() {
      ...
      if ($Qupcoming->numberOfRows() > 0) {
        ...
        $osC_Template->addStyleDeclaration('.clearLeft{clear:right;}
	                                          .upcomingProductsModule{overflow: auto; height: 100%;}
	                                          .upcomingProductsModule .productItem{width: 32%; float: right; text-align: center; padding: 2px;}
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('حداکثر موارد برای نمایش', 'MODULE_CONTENT_UPCOMING_PRODUCTS_MAX_DISPLAY', '10', 'حداکثر تعداد محصولات آینده برای نمایش', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('کش محتویات', 'MODULE_CONTENT_UPCOMING_PRODUCTS_CACHE', '1440', 'تعداد دقایقی که محتویات در حافظه کش ذخیره شود (0 = ذخیره نشود)', '6', '0', now())");
    }
