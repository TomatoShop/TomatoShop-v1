...
/* Class constructor */
    ...
    function initialize() {
      ...
      $css = '#sliderLeft, #sliderRight {height:' . $height . 'px;line-height:' . $height . 'px;width:30px;float:right;vertical-align:middle}' . "\n" .
             ...
             '#productsSliderWrapper {position:relative;background:#fff;width:' . $wrapper_width . 'px;height:' . $height . 'px;overflow:hidden;float:right;}' . "\n" .
             '#productsSlider {position:absolute;text-align:center}' . "\n" .
             '#productsSlider span {display:block; float:right;width:' . $image_width . 'px}';
