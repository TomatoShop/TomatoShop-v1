...
/* Class constructor */
    ...
    function initialize() {
      ...
      if ($Qproducts->numberOfRows()) {
        ...
        while ($Qproducts->next()) {
          ...
          $this->_content .= '<span style="width: 32%; float: right; text-align: center; padding: 2px;">' .
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('حداکثر موارد برای نمایش', 'MODULE_CONTENT_FEATURE_PRODUCTS_MAX_DISPLAY', '9', 'حداکثر تعداد محصولات پیشنهادی برای نمایش', '6', '0', now())");
    }
