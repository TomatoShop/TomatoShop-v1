...
?>
  ...
  <li><?php echo osc_draw_label($osC_Language->get('field_customer_street_address'), 'street_address', 'street_address', true) . osc_draw_textarea_field('street_address', (isset($Qentry) ? $Qentry->value('entry_street_address') : null), 35, 3); ?></li>
...
?>
  ...
  <li><?php echo osc_draw_label($osC_Language->get('field_customer_post_code'), 'postcode', 'postcode', (ACCOUNT_POST_CODE > 0)) . osc_draw_input_field('postcode', (isset($Qentry) ? $Qentry->value('entry_postcode') : null), 'dir="ltr"'); ?></li>
...
?>
  ...
  <li><?php echo osc_draw_label($osC_Language->get('field_customer_telephone_number'), 'telephone', 'telephone', (ACCOUNT_TELEPHONE > 0)) . osc_draw_input_field('telephone', (isset($Qentry) ? $Qentry->value('entry_telephone') : null), 'dir="ltr"'); ?></li>
...
?>
  ...
  <li><?php echo osc_draw_label($osC_Language->get('field_customer_fax_number'), 'fax', 'fax', (ACCOUNT_FAX > 0)) . osc_draw_input_field('fax', (isset($Qentry) ? $Qentry->value('entry_fax') : null), 'dir="ltr"'); ?></li>
