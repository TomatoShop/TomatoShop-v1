...
?>
            ...
            <td align="left"><?php echo osc_draw_radio_field('payment_method', $selection[$i]['id'], ($osC_ShoppingCart->hasBillingMethod() ? $osC_ShoppingCart->getBillingMethod('id') : null)); ?></td>
...
<?php echo '<b>' . $osC_Language->get('coupons_redeem_information_title') . '</b>'; ?><br/>
    <div>
      ...
      <?php echo osc_draw_input_field('coupon_redeem_code','','dir="ltr"'); ?>&nbsp;&nbsp;
...
?>
    <div>
      ...
      <?php echo osc_draw_input_field('gift_certificate_redeem_code', null, 'id="gift_certificate_code" dir="ltr"'); ?>&nbsp;&nbsp;
