...
?>
            ...
            <td align="left"><?php echo osc_draw_radio_field('shipping_mod_sel', $quotes['id'] . '_' . $methods['id'], $osC_ShoppingCart->getShippingMethod('id')); ?></td>
<?php
          } else {
?>
            <td align="left" colspan="2"><?php echo $osC_Currencies->displayPrice($methods['cost'], $quotes['tax_class_id']) . osc_draw_hidden_field('shipping_mod_sel', $quotes['id'] . '_' . $methods['id']); ?></td>
<?php
          }
?>
            <td width="10">&nbsp;</td>
...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <h6><?php echo '<b>' . $osC_Language->get('gift_wrapping_heading_comment') . '</b>'; ?></h6>
