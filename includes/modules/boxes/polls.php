...
*/
  ...
  class osC_Boxes_polls extends osC_Modules {
    ...
    function initialize() {
      ...
      if ($Qpoll->numberOfRows() > 0) {
        ...
        if ($Qanswers->numberOfRows() > 0) {
          ...
          $this->_content .= '<span style="float: left;">' . osc_draw_image_button('button_vote.png', $osC_Language->get('button_vote'), 'class="button" id="btnPollVote"') . '</span>';          
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('عدم اجازه براي ثبت بيش از يک راي توسط يک آدرس آي پي', 'DISALLOW_MORE_THAN_ONE_VOTE_FROM_ONE_IP', '1', 'عدم مجوز برای دریافت بیش از یک رای از یک آدرس آی پی', '19', '1', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    }
