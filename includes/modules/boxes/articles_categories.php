...
*/
  ...
  class osC_Boxes_articles_categories extends osC_Modules {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('حداکثر اندازه فهرست', 'BOX_ARTICLES_CATEGORIES_MAX_LIST', '10', 'مقدار حداکثر از دسته بندی مقاله برای نمایش در این فهرست', '6', '0', now())");
    }
