  ...
  class osC_Boxes_shopping_cart extends osC_Modules {
    ...
    function initialize() {
      ...
      $content = '<div id="ajaxCartContent">' .
                  ...
                  '<div id="ajaxCartContentLong" class="expanded">' .
                    ...
                    '<div id="ajaxCartButtons">' .
                      osc_link_object(osc_href_link(FILENAME_CHECKOUT), osc_draw_image_button('button_ajax_cart.png'), 'id="ajax-shopping-button-cart"') .
      ...
      $css = '#ajaxCartContent {overflow: hidden;}' . chr(13) . 
             ...
             '#ajaxCartOrderTotals span.orderTotalText {float: left}' . chr(13) .
             '#ajaxCartContentLong ul.products {text-align: right;}' .  chr(13) .
             '#ajaxCartContentLong ul li {padding: 6px 0;font-size: 9px;position: relative;line-height:16px;}' . chr(13) .
             '#ajaxCartContentLong ul.products span.price {display:block;position:absolute;left:15px;top:8px;}' . chr(13) .
             '#ajaxCartContentLong ul.products .removeProduct {cursor: pointer;display: block;width: 11px;height: 13px;position: absolute;left: 0;top: 8px;background: url(includes/languages/' . $osC_Language->getCode() . '/images/buttons/button_ajax_cart_delete.gif) no-repeat right top;}' . chr(13) .
             ...
             '#ajaxCartContentLong p.variants, #ajaxCartContentLong p.customizations { padding: 2px;margin: 0 5px 0 0; }' . chr(13) .
             '#ajaxCartContentShort span.cartTotal {float:left; font-weight: bold}' . chr(13) .
