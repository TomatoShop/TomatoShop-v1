...
*/
  ...
  class osC_Boxes_popular_search_terms_tag_cloud extends osC_Modules {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('کش محتویات', 'BOX_POPULAR_SEARCH_TERM_CACHE', '60', 'تعداد دقایقی که محتویات در حافظه کش ذخیره شود(0 = ذخیره نشود)', '6', '0', now())");
    }
