...
*/
  ...
  class osC_Boxes_guest_book extends osC_Modules {
    ...
    function initialize() {
      ...
      $this->_content .= '<p align="left">' . osc_link_object(osc_href_link(FILENAME_INFO, 'guestbook'), osc_draw_image_button('small_read_more.png', $osC_Language->get('button_read_more'))) . '</p>';
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('تعداد نوشته ها', 'BOX_GUEST_BOOK_LIST', '3', 'تعداد نوشته ها برای نمایش در باکس کتاب مهمان', '6', '0', now())");
    }
