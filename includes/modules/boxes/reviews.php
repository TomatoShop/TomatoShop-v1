...
*/
  ...
  class osC_Boxes_reviews extends osC_Modules {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('انتخاب تصادفی نظرات', 'BOX_REVIEWS_RANDOM_SELECT', '10', 'انتخاب تصادفی نظرات به این تعداد از بین نظرات در دسترس', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('کش محتویات', 'BOX_REVIEWS_CACHE', '1', 'تعداد دقایقی که محتویات در حافظه کش ذخیره می شود (0 = ذخیره نمی شود)', '6', '0', now())");
    }
