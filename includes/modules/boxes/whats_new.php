...
*/
  ...
  class osC_Boxes_whats_new extends osC_Modules {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('انتخاب تصادفی محصول جدید', 'BOX_WHATS_NEW_RANDOM_SELECT', '10', 'انتخاب تصادفی محصول جدید به این تعداد از بین جدیدترین محصولات در دسترس', '6', '0', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('کش محتویات', 'BOX_WHATS_NEW_CACHE', '1', 'تعداد دقایقی که محتویات در حافظه کش ذخیره شود(0 = ذخیره نشود)', '6', '0', now())");
    }
