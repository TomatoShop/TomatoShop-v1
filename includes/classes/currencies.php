...
// class methods
    function format($number, $currency_code = '', $currency_value = '') {
      ...
      return $this->currencies[$currency_code]['symbol_right'] .' '. number_format(osc_round($number * $currency_value, $this->currencies[$currency_code]['decimal_places']), $this->currencies[$currency_code]['decimal_places'], $osC_Language->getNumericDecimalSeparator(), $osC_Language->getNumericThousandsSeparator()) .' '. $this->currencies[$currency_code]['symbol_left'];
    }
