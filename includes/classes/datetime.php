...
//persian date By ALI Masooumi
  require('includes/functions/jdf/jdf.php');
  class osC_DateTime {
    function getNow() {
...
// hejri short date
    function getShort($date = null, $with_time = false) {
      ...
      if (@date('Y', mktime($hour, $minute, $second, $month, $day, $year)) == $year) {
        return jstrftime($osC_Language->getDateFormatShort($with_time), mktime($hour, $minute, $second, $month, $day, $year), '', '', 'en');
      } else {
        return ereg_replace('2037', $year, jstrftime($osC_Language->getDateFormatShort($with_time), mktime($hour, $minute, $second, $month, $day, 2037), '', '', 'en'));
      }
    }
	// short date	
    function getShortg($date = null, $with_time = false) {
      global $osC_Language;
...
// hejri long date 
    function getLong($date = '') {
      ...
      if (@date('Y', mktime($hour, $minute, $second, $month, $day, $year)) == $year) {
        return jstrftime($osC_Language->getDateFormatLong(), mktime($hour, $minute, $second, $month, $day, $year), '', '', 'en');
      } else {
        return ereg_replace('2037', $year, jstrftime($osC_Language->getDateFormatLong(), mktime($hour, $minute, $second, $month, $day, 2037), '', '', 'en'));
      }
    }
	
    function getLongg($date = '') {
      global $osC_Language;
