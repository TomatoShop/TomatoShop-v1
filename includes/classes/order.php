...
/* Public methods */
    ...
    function insert($order_status = DEFAULT_ORDERS_STATUS_ID) {
      ...
      if ($osC_ShoppingCart->isUseStoreCredit()) {
        $Qhistory = $osC_Database->query('insert into :table_customers_credits_history (customers_id, orders_id, action_type, date_added, amount, comments) values (:customers_id, :orders_id, :action_type, now(), :amount, :comments)');
        ...
        $Qhistory->bindInt(':orders_id', $insert_id);
