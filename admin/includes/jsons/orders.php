...
*/
  ...
  class toC_Json_Orders {
    ...
    function getCustomerAddresses() {
      ...
      while ( $Qaddresses->next() ) {
        $records[] = array('id' => $Qaddresses->valueInt('address_book_id'),
                           'text' => $Qaddresses->value('firstname') . ' ' . $Qaddresses->value('lastname') . ',' . $Qaddresses->value('company') . ',' . $Qaddresses->value('street_address') . ',' . $Qaddresses->value('suburb') . ',' . $Qaddresses->value('city') . ',' . $Qaddresses->value('postcode') . ',' . $Qaddresses->value('zone_title') . ',' . $Qaddresses->value('country_title') . ',' . $Qaddresses->value('telephone_number'));
      }
    ...
    function saveAddress() {
      ...
      $data['billing_telephone'] = $_REQUEST['billing_telephone'];
      ...
      $data['delivery_telephone'] = $_REQUEST['shipping_telephone'];
    ...
    function loadOrder() {
      ...
      $data = array('customers_name' => $osC_Order->_customer['name'],
                    ...
                    'billing_address' => str_replace(',', ' ', $osC_Order->getBilling('name')) . ',' .
                                        ...
                                        $osC_Order->getBilling('telephone_number'),
                    'shipping_address' => str_replace(',', ' ', $osC_Order->getDelivery('name')) . ',' .
                                        ...
                                        $osC_Order->getDelivery('telephone_number'));
