...
*/
  ...
  class osC_Services_google_analytics_Admin {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('افزودن کد گوگل آنالیز', 'SERVICES_GOOGLE_ANALYTICS_CODE', '', 'کد آنالیز گوگل برای ردیابی اطلاعات مربوط به بازدیدکنندگان سایت', '6', '0', 'osc_cfg_set_textarea_field', now())");
    }
