...
*/
  ...
  class osC_Services_category_path_Admin {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('محاسبه تعداد محصولات هر شاخه', 'SERVICES_CATEGORY_PATH_CALCULATE_PRODUCT_COUNT', '1', 'آیا تعداد محصولات هر شاخه برای نمایش جلوی اسم شاخه محاسبه شود؟', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    }
