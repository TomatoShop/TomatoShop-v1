...
*/
  ...
  class osC_Services_whos_online_Admin {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('شناسایی روبات موتورهای جستجو', 'SERVICE_WHOS_ONLINE_SPIDER_DETECTION', '1', 'شناسایی ربات های موتورهای جستجو (GoogleBot, Yahoo, etc)', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    }
