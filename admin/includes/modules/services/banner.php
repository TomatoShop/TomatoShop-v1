...
*/
  ...
  class osC_Services_banner_Admin {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('نمایش تکراری تبلیغات', 'SERVICE_BANNER_SHOW_DUPLICATE', '-1', 'نمایش تکراری تبلیغات در یک گروه تصویر در یک صفحه؟', '6', '0', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    }
