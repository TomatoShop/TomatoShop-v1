...
*/
  ...
  class osC_Services_sefu_Admin {
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function ,date_added) values ('از کلمات کلیدی متن URL ساخت', 'SERVICES_KEYWORD_RICH_URLS', '1', 'ایجاد آدرس صفحه دربردارنده کلمات کلیدی نوشته برای شاخه ها ، محصولات ، مقالات و سوالات رایج', '6', '7', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now())");
    }
