...
// class methods
    ...
    function install() {
      ...
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) VALUES ('فعالسازی روش منطقه ای', 'MODULE_SHIPPING_ZONES_STATUS', 'True', 'از روش حمل و نقل منطقه ای استفاده می کنید؟', '6', '0', 'osc_cfg_set_boolean_value(array(\'True\', \'False\'))', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('کلاس مالیاتی', 'MODULE_SHIPPING_ZONES_TAX_CLASS', '0', 'از کلاس مالیاتی زیر برای هزینه حمل و نقل استفاده شود', '6', '0', 'osc_cfg_use_get_tax_class_title', 'osc_cfg_set_tax_classes_pull_down_menu', now())");
      $osC_Database->simpleQuery("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('ترتیب نمایش', 'MODULE_SHIPPING_ZONES_SORT_ORDER', '0', 'ترتیب نمایش', '6', '0', now())");
