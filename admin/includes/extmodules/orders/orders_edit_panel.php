...
Ext.extend(Toc.orders.OrdersEditPanel, Ext.Panel, {
  buildForm: function(config){
    ...
    this.fsBillingAddress = new Ext.form.FieldSet({
      ...
      items: [
        ...
        this.txtBillingTelephone = new Ext.form.TextField({fieldLabel: '<?php echo $osC_Language->get('field_customers_telephone'); ?>', name: 'billing_telephone'})
      ],
    ...
    this.fsShippingAddress = new Ext.form.FieldSet({
      ...
      items: [
        ...
        this.txtShippingTelephone = new Ext.form.TextField({id: 'fsShippingAddress-telephone', fieldLabel: '<?php echo $osC_Language->get('field_customers_telephone'); ?>', name: 'shipping_telephone'})
      ],
      buttons: [{text: '<?php echo $osC_Language->get('button_update');?>', iconCls:'refresh', handler: this.submitForm, scope: this}]
    });
  ...
  resetBillingAddress: function () {
    ...
    this.txtBillingTelephone.setValue('');
  ...
  setBillingAddress: function(address) {
    ...
    if (data.length > 1){
       ...
       this.txtBillingTelephone.setValue(data[8]);
  ...
  resetShippingAddress: function () {
    ...
    this.txtShippingTelephone.setValue('');
  ...
  setShippingAddress: function(address) {
    ...
    if (data.length > 1){
       ...
       this.txtShippingTelephone.setValue(data[8]);
