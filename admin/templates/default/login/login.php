...
<body scroll="no">
  <div id="x-loading-mask" style="width:100%; height:100%; background:#000000; position:absolute; z-index:20000; right:0; top:0;">&#160;</div>
  <div id="x-loading-panel" style="direction: rtl; position:absolute;right:40%;top:40%;border:1px solid #9c9f9d;padding:2px;background:#d1d8db;width:300px;text-align:center;z-index:20001;">
    <div class="x-loading-panel-mask-indicator" style="border:1px solid #c1d1d6;color:#666;background:white;padding:10px;margin:0;padding-right: 20px;height:110px;text-align:right;">
      ...
      <div style="text-align:center; font-size:10px; font-weight:normal; margin-top:15px;">Copyright &copy; 2009 Wuxi Elootec Technology Co., Ltd</div>
	        <p style=""></p>
    </div>
  </div> 
  ...
  <div id="x-login-panel">
    ...
    <div class="login-features abs-position">
      <p>تومیتوشاپ - فروشگاه ساز حرفه ای و متن باز</p>
      <p align="justify">مجهز به تکنولوژی مدرن AJAX و Rich Internet Applications تحت چهارچوب نرم افزاری ExtJS ، تومیتوشاپ   راه حل های اساسی قابل استفاده را عرضه نموده و از تقابل آنها رابطه های سریع و موثر تحت وب ایجاد می نماید.</p>
      <p align="left"><a style="text-decoration: none;" href="http://www.tomatoshop.ir/" target="_blank">گروه پشتیبانی تومیتوشاپ</a></p>
	  </div>
    ...
    <span class="login-supported abs-position">
      <b>مرورگرهاي پشتيباني شده</b><br />
      <a href="http://www.mozilla.org/download.html" target="_blank">فايرفاکس +2</a><br />
      <a href="http://www.microsoft.com/windows/downloads/ie/getitnow.mspx" target="_blank">اينترنت اکسپلورر +7</a><br />
      <a href="http://www.opera.com/download/" target="_blank">اپرا +9</a>
    </span>
