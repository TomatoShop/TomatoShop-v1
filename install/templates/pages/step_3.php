...
<!--
  ...
  function handleHttpResponse_DoImport() {
    if (http.readyState == 4) {
      if (http.status == 200) {
        ...
        if (result[0] == '1') {
          document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/success.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_imported'); ?></p>';

          setTimeout("document.getElementById('installForm').submit();", 2000);
        } else {
          document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_import_error'); ?></p>'.replace('%s', result[1]);
        }
      }
  ...
  function handleHttpResponse() {
    if (http.readyState == 4) {
      if (http.status == 200) {
        ...
        if (result[0] == '1') {
          document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/progress.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_importing'); ?></p>';
          ...
          document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_connection_error'); ?></p>'.replace('%s', result[1]);
          formSubmited = false;
        }
      } else {
        formSubmited = false;
  ...
  function prepareDB() {
    ...
    document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/progress.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_connection_test'); ?></p>';
    ...
    <div class="contentPane">
      ...
      <p><?php echo $osC_Language->get('text_database_server_setup'); ?></p>
	    ...
	    <table border="0" width="99%" cellspacing="0" cellpadding="0" class="inputForm">
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_server') . '<br />' . osc_draw_input_field('DB_SERVER', null, 'class="text" dir="ltr"'); ?>
	          <br />
	      ...
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_username') . '<br />' . osc_draw_input_field('DB_SERVER_USERNAME', null, 'class="text" dir="ltr"'); ?>
	          <br />
	      ...
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_password') . '<br />' . osc_draw_password_field('DB_SERVER_PASSWORD', 'class="text" dir="ltr"'); ?>
	          <br />
	      ...
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_name') . '<br />' . osc_draw_input_field('DB_DATABASE', null, 'class="text" dir="ltr"'); ?>
	          <br />
	      ...
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_type') . '<br />' . osc_draw_pull_down_menu('DB_DATABASE_CLASS', $db_table_types,'', 'dir="ltr"'); ?>
	          <br />
	      ...
	      <tr>
	        <td class="inputField">
	          <?php echo $osC_Language->get('param_database_prefix') . '<br />' . osc_draw_input_field('DB_TABLE_PREFIX', 'toc_', 'class="text" dir="ltr"'); ?>
	          <br />
