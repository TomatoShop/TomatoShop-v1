    ...
    <div class="infoPaneContents">
      <div style="float: left;">
	      ...
	      ?>
	        <tr>
	          ...
	          <td align="left"><img src="images/<?php echo (is_writable($root_dir . $directory) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	      <?php
	        }
	      ?>
     ...
     <div>
          ...
          <tr>
            ...
            <td align="left"><?php echo (((int)ini_get('safe_mode') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
            <td align="left"><img src="images/<?php echo (((int)ini_get('safe_mode') === 0) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
          </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_register_globals'); ?></td>
	          <td align="left"><?php echo (((int)ini_get('register_globals') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
	          <td align="left"><img src="images/<?php echo (((int)ini_get('register_globals') === 0) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_magic_quotes'); ?></td>
	          <td align="left"><?php echo (((int)ini_get('magic_quotes') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
	          <td align="left"><img src="images/<?php echo (((int)ini_get('magic_quotes') === 0) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_file_uploads'); ?></td>
	          <td align="left"><?php echo (((int)ini_get('file_uploads') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
	          <td align="left"><img src="images/<?php echo (((int)ini_get('file_uploads') === 1) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_session_auto_start'); ?></td>
	          <td align="left"><?php echo (((int)ini_get('session.auto_start') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
	          <td align="left"><img src="images/<?php echo (((int)ini_get('session.auto_start') === 0) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_session_use_trans_sid'); ?></td>
	          <td align="left"><?php echo (((int)ini_get('session.use_trans_sid') === 0) ? $osC_Language->get('box_server_off') : $osC_Language->get('box_server_on')); ?></td>
	          <td align="left"><img src="images/<?php echo (((int)ini_get('session.use_trans_sid') === 0) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	      </table>
	      ...
	      <table border="0" width="300" cellspacing="0" cellpadding="2">
	        <tr>
	          ...
	          <th align="left"><?php echo phpversion(); ?></th>
	          <th align="left" width="25"><img src="images/<?php echo ((phpversion() >= '5.1.6') ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></th>
	        </tr>
	      </table>
	      ...
	      <table border="0" width="300" cellspacing="0" cellpadding="2">
	        ...
	        <tr>
	          ...
	          <td align="left"><img src="images/<?php echo (extension_loaded('mysql') ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_gd'); ?></td>
	          <td align="left"><img src="images/<?php echo (extension_loaded('gd') ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_curl'); ?></td>
	          <td align="left"><img src="images/<?php echo (extension_loaded('curl') ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	        <tr>
	          <td><?php echo $osC_Language->get('box_server_openssl'); ?></td>
	          <td align="left"><img src="images/<?php echo (extension_loaded('openssl') ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	      </table>
	      ...
	      ?>
	        <tr>
	          <td><?php echo $file; ?></td>
	          <td align="left"><img src="images/<?php echo (is_writable($root_dir . $file) ? 'ok.png' : 'error.png'); ?>" border="0" width="16" height="16"></td>
	        </tr>
	      <?php
	        }
	      ?>
