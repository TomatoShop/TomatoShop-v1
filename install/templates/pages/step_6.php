...
?>
    ...
    <div class="noticeBox">
      ...
      <p align="left"><?php echo '<input type="image" src="templates/' . $template . '/languages/' . $osC_Language->getCode() . '/images/buttons/retry.gif" border="0" alt="' . $osC_Language->get('image_button_retry') . '" />'; ?></p>
...
?>
    ...
    <p align="center">
      <a href="<?php echo $http_server . $http_catalog . 'index.php'; ?>" target="_blank"><img src="<?php echo 'templates/' . $template . '/languages/' . $osC_Language->getCode() . '/images/button_catalog.gif '?>" border="0" alt="فروشگاه" /></a>
      &nbsp;&nbsp;
      <a href="<?php echo $http_server . $http_catalog . 'admin/index.php'; ?>" target="_blank"><img src="<?php echo 'templates/' . $template . '/languages/' . $osC_Language->getCode() . '/images/button_administration_tool.gif '?>" border="0" alt="مدیریت فروشگاه ساز" /></a>
    </p>
