...
<!--
  ...
  function handleHttpResponse() {
    if (http.readyState == 4) {
      if (http.status == 200) {
        ...
        if (result[0] == '1') {
          document.getElementById('mBoxContents').innerHTML = '<p><img src="images/success.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_work_directory_configured'); ?></p>';

          setTimeout("document.getElementById('installForm').submit();", 2000);
        } else if (result[0] == '0') {
          document.getElementById('mBoxContents').innerHTML = '<p><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_work_directory_error_not_writeable'); ?></p>'.replace('%s', result[1].wordWrap(30, '<br />', true));
        } else {
          document.getElementById('mBoxContents').innerHTML = '<p><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_work_directory_error_non_existent'); ?></p>'.replace('%s', result[1].wordWrap(30, '<br />', true));
        }
      }
  ...
  function prepareWork() {
    ...
    document.getElementById('mBoxContents').innerHTML = '<p><img src="images/progress.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_work_directory_test'); ?></p>';
  ...
  <div class="contentBlock">
    <div class="contentPane">
      ...
      <table border="0" width="99%" cellspacing="0" cellpadding="5" class="inputForm">
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_web_address') . '<br />' . osc_draw_input_field('HTTP_WWW_ADDRESS', $www_location, 'class="text" dir="ltr"'); ?>
            <br>
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_web_root_directory') . '<br />' . osc_draw_input_field('DIR_FS_DOCUMENT_ROOT', $dir_fs_www_root, 'class="text" dir="ltr"'); ?>
            <br>
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_web_work_directory') . '<br /><span style="white-space: nowrap;">' . osc_draw_input_field('HTTP_WORK_DIRECTORY', $dir_fs_www_root . 'includes/work', 'class="text" dir="ltr"'); ?></span><div class="autoComplete" id="divAutoComplete"></div>
            <br>
