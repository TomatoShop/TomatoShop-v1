...
<!--
  ...
  function handleHttpResponse() {
    if (http.readyState == 4) {
      if (http.status == 200) {
        ...
        if (result[0] == '1') {
          document.getElementById('mBoxContents').innerHTML = '<p><img src="images/success.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_sample_data_imported'); ?></p>';

          setTimeout("document.getElementById('installForm').submit();", 2000);
        } else {
          document.getElementById('mBoxContents').innerHTML = '<p><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_sample_data_import_error'); ?></p>'.replace('%s', result[1]);
        }
      }
  ...
  function prepareDB() { 
    ...
    if(document.getElementById("CFG_ADMINISTRATOR_USERNAME").value.length == 0) {
      ...
      setTimeout(" ", 1000);
      document.getElementById('mBoxContents').innerHTML = '<p style="width:180px;"><img src="images/failed.gif" align="left" hspace="5" vspace="5" border="0" />'+errorMassage+'</p>';
      error = true;
    }
    ...
    if(error == false) {
	    if (document.getElementById("DB_INSERT_SAMPLE_DATA").checked) {
	      ...
	      document.getElementById('mBoxContents').innerHTML = '<p><img src="images/progress.gif" align="left" hspace="5" vspace="5" border="0" /><?php echo $osC_Language->get('rpc_database_sample_data_importing'); ?></p>';
  ...
  <div class="contentBlock">
    <div class="contentPane">
      ...
      <table border="0" width="99%" cellspacing="0" cellpadding="5" class="inputForm">
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_store_owner_email_address') . '<br />' . osc_draw_input_field('CFG_STORE_OWNER_EMAIL_ADDRESS', null, 'class="text" dir="ltr"'); ?>
            <br>
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_administrator_username') . '<br />' . osc_draw_input_field('CFG_ADMINISTRATOR_USERNAME', null, 'class="text" dir="ltr"'); ?>
            <br>
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_administrator_password') . '<br />' . osc_draw_password_field('CFG_ADMINISTRATOR_PASSWORD', 'class="text" dir="ltr"'); ?>
            <br>
        ...
        <tr>
          <td class="inputField">
            <?php echo $osC_Language->get('param_confirm_password') . '<br />' . osc_draw_password_field('CFG_CONFIRM_PASSWORD', 'class="text" dir="ltr"'); ?>
            <br>
            <span><?php echo $osC_Language->get('param_administrator_password_description'); ?></span>            
          </td>
        </tr>      
