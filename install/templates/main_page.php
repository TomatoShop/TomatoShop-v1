...
<title>تومیتوکارت پارسی ، فروشگاه ساز متن باز و رایگان</title>
...
<div id="wapper" dir="rtl" >
  <div id="pageHeader">
    <div style="float: left; padding-top: 40px; padding-left: 15px; color: #000000; font-weight: bold;"><a href="http://www.tomatoshop.ir" target="_blank"><?php echo $osC_Language->get('head_tomatocart_persian_support_title'); ?></a> &nbsp;|&nbsp;<a href="http://www.tomatocart.com" target="_blank"><?php echo $osC_Language->get('head_tomatocart_support_title'); ?></a> &nbsp;|&nbsp;<a href="http://www.tomatocart.com/index.php/community/forum" target="_blank"><?php echo $osC_Language->get('head_tomatocart_support_forum_title'); ?></a> &nbsp;|&nbsp; <a href="http://www.oscommerce.com" target="_blank"><?php echo $osC_Language->get('head_oscommerce_support_title'); ?></a></div>
    <a href="index.php"><img src="<?php echo 'templates/' . $template . '/languages/' . $osC_Language->getCode() . '/images/logo.png '?>" border="0" title="<?php echo $osC_Language->get('install_tomatocart_title'); ?>" style="margin: 10px 10px 0px 10px;" /></a>
  </div>
