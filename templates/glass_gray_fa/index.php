...
<?php } ?>
<link rel="stylesheet" type="text/css" href="templates/<?php echo $osC_Template->getCode(); ?>/rtl.css" />
<!--[if IE]><link rel="stylesheet" href="templates/<?php echo $osC_Template->getCode(); ?>/ie.css" /><![endif]-->
<!--[if IE]>
<style type="text/css">
  #productInfoTab a {
    top:11px;
...
<?php
  $content_left = $osC_Template->getBoxGroup('right');
  $content_right = $osC_Template->getBoxGroup('left');
      ...
      <ul id="navigation">
        <?php
          ...
          echo '<li ' . ($osC_Template->getGroup() == 'account' ? 'class="navVisited"' : null) . '><span class="navLeftHook">&nbsp;</span>' . osc_link_object(osc_href_link(FILENAME_ACCOUNT, null, 'SSL'), $osC_Language->get('my_account')) . '<span class="navHoverDownHook">&nbsp;</span><span class="navRightHook">&nbsp;</span></li>' .
               ...
               '<li ' . ($osC_Template->getGroup() == 'info' && $osC_Template->getModule() == 'contact' ? 'class="navVisited lastitem"' : 'class="lastitem"') . '><span class="navLeftHook">&nbsp;</span>' . osc_link_object(osc_href_link(FILENAME_INFO, 'contact'), $osC_Language->get('contact_us')) . '<span class="navHoverDownHook">&nbsp;</span><span class="navRightHook">&nbsp;</span></li>';
        ?>
      </ul>
  ...
  window.addEvent('domready', function() {
    ...
    new TocAutoCompleter('keywords', {
      ...
      maxChoices: <?php echo defined('MAX_DISPLAY_AUTO_COMPLETER_RESULTS') ? MAX_DISPLAY_AUTO_COMPLETER_RESULTS : 10;?>,
			width: <?php echo defined('WIDTH_AUTO_COMPLETER') ? WIDTH_AUTO_COMPLETER : 350; ?>,
