...
?>
  <div class="moduleBox">
    ...
    <h6><span style="float: left;"><?php echo osC_DateTime::getShort($Qarticles->value('articles_date_added')); ?></span><?php echo osc_link_object(osc_href_link(FILENAME_INFO, 'articles&articles_id=' . $Qarticles->valueInt('articles_id')), $Qarticles->value('articles_name')); ?></h6>

    <div class="content">

  <?php
      if (!osc_empty($Qarticles->value('articles_image'))) {
        echo osc_link_object(osc_href_link(FILENAME_INFO, 'articles&articles_id=' . $Qarticles->valueInt('articles_id')), $osC_Image->show($Qarticles->value('articles_image'), $Qarticles->value('articles_name'), 'style="float: right;margin: 5px 5px 5px 10px"', '', 'articles'));
      }
  ?>
...
?>
  ...
  <div class="listingPageLinks">
    <span style="float: left;"><?php echo $Qarticles->getBatchPageLinks('page', osc_get_all_get_params(array('x', 'y'))); ?></span>
