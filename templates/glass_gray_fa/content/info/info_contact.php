...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <div style="float: left; padding: 0px 20px 10px 0px; text-align: center;">
      <?php echo '<b>' . $osC_Language->get('contact_store_address_title') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_south_west.gif'); ?>
    </div>
...
<div class="moduleBox">
  ...
  <div class="content contact">
    ...
    <?php } ?>
      ...
      <li><?php echo osc_draw_label($osC_Language->get('contact_telephone_title'), 'telephone') . osc_draw_input_field('telephone', '', 'size="30" dir="ltr"'); ?></li>
      <li><?php echo osc_draw_label($osC_Language->get('contact_email_address_title'), 'email', null, true) . osc_draw_input_field('email', $osC_Customer->getEmailAddress(), 'size="30" dir="ltr"'); ?></li>
