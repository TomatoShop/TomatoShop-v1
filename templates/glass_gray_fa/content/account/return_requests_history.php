...
<div class="moduleBox">
  ...
  <h6><span style="float: left;"><?php echo $osC_Language->get('order_return_date_added') . ' ' . osC_DateTime::getShort($Qhistory->value('date_added')); ?></span><?php echo $osC_Language->get('order_return_number') . ' ' . $Qhistory->value('orders_returns_id') . ' (' . $Qhistory->value('orders_returns_status_name') . ')';?> </h6>
     ...
     <table border="0" width="100%" cellspacing="2" cellpadding="4">
       ...
       <tr>
          ...
          ?>
              ...
              <td colspan="2" align="left"><?php echo osc_link_object(osc_href_link(FILENAME_PDF, 'module=account&pdf=return_slip&orders_returns_id=' . $Qhistory->value('orders_returns_id')), osc_draw_image_button('button_print.png', $osC_Language->get('return_slip'))); ?></td>
...
<div class="listingPageLinks">
  <span style="float: left;"><?php echo $Qhistory->getBatchPageLinks('page', 'orders=list_return_requests'); ?></span>
