...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <div style="float: left; padding: 0px 20px 10px 0px; text-align: center;">
      <?php echo '<b>' . $osC_Language->get('selected_address_title') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_south_west.gif'); ?>
    </div>
...
<div class="submitFormButtons">
  <span style="float: left;"><?php echo osc_link_object(osc_href_link(FILENAME_ACCOUNT, 'address_book=' . $_GET['address_book'] . '&delete=confirm', 'SSL'), osc_draw_image_button('button_delete.gif', $osC_Language->get('button_delete'))); ?></span>
