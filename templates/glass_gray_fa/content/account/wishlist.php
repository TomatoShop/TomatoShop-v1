...
<div class="moduleBox">
  ...
  ?>
	...
	<span style="float: left;"><?php echo  osc_draw_image_submit_button('button_update.gif') ; ?></span>
    ...
    <div class="moduleBox">
      ...
      <form name="share_wishlist" id="share_wishlist" method="post" action="<?php echo osc_href_link(FILENAME_ACCOUNT, 'wishlist=share_wishlist', 'SSL'); ?>">      
        <div class="content">   
          ...
          <p><?php echo osc_draw_label($osC_Language->get('field_share_wishlist_customer_email'), 'wishlist_from_email', null, true) . ' ' . osc_draw_input_field('wishlist_from_email', ($osC_Customer->isLoggedOn() ? $osC_Customer->getEmailAddress() : null),'dir="ltr"'); ?></p>
          
          <p><?php echo osc_draw_label($osC_Language->get('field_share_wishlist_emails'), 'wishlist_emails', null, true) . ' ' . osc_draw_textarea_field('wishlist_emails', null, 40, 5,'dir="ltr"'); ?></p>
