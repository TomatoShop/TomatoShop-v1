...
<div class="moduleBox">
  ...
  <div class="content">
    ...
    <div style="float: left; padding: 0px 20px 10px 0px; text-align: center;">
      <?php echo '<b>' . $osC_Language->get('primary_address_title') . '</b><br />' . osc_image(DIR_WS_IMAGES . 'arrow_south_west.gif'); ?>
    </div>
