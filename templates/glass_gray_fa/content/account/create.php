...
?>
      ...
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_date_of_birth'), 'dob_days', null, true) . osc_draw_jdate_pull_down_menu('dob', null, false, null, null, date('Y')-1921, -5); ?></li>
<?php
  }
?>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_email_address'), 'email_address', null, true) . osc_draw_input_field('email_address', null, 'dir="ltr"'); ?></li>
...
?>
      ...
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_password'), 'password', null, true) . osc_draw_password_field('password', 'AUTOCOMPLETE="off" dir="ltr"'); ?></li>
      <li><?php echo osc_draw_label($osC_Language->get('field_customer_password_confirmation'), 'confirmation', null, true) . osc_draw_password_field('confirmation', 'AUTOCOMPLETE="off" dir="ltr"'); ?></li>
      ...
      <li class="clearfix captcha" style="height:130px !important;">
        <table width="200" border="0">
          <tr>
            <td>&nbsp;</td>
            <td><?php echo osc_image(osc_href_link(FILENAME_ACCOUNT, 'create=show_captcha', 'AUTO', true, false), $osC_Language->get('captcha_image_title'), 215, 80, 'id="captcha-code"'); ?></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
