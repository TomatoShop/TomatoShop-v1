...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:right"><?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/my_account.png', $osC_Language->get('my_account_title')); ?></div>

    <ul style="float:right;padding-right:40px;list-style-image: url(<?php echo osc_href_link('templates/' . $osC_Template->getCode() . '/images/arrow_gray.png', null, 'SSL'); ?>);">
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:right"><?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/my_orders.png', $osC_Language->get('my_orders_title')); ?></div>
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:right"><?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/my_wishlist.png', $osC_Language->get('my_wishlist_title')); ?></div>
...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float:right"><?php echo osc_image('templates/' . $osC_Template->getCode() . '/images/my_notifications.png', $osC_Language->get('my_notifications_title')); ?></div>
