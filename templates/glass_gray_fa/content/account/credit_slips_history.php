...
<div class="moduleBox">
  ...
  <h6><span style="float: left;"><?php echo $osC_Language->get('date_added') . '&nbsp;' . osC_DateTime::getShort($Qslips->value('date_added')) ; ?></span><?php echo $osC_Language->get('credit_slip_number') . '&nbsp;' . $Qslips->value('credit_slips_id');?> </h6>
   ...
   <div class="content">
    ...
    <p align="left"><?php echo osc_link_object(osc_href_link(FILENAME_PDF, 'module=account&pdf=credit_slip&credit_slip_id=' . $Qslips->value('credit_slips_id')), osc_draw_image_button('button_print.png', $osC_Language->get('credit_slips'))); ?></p>
  </div>
</div>
...
<div class="listingPageLinks">
  <span style="float: left;"><?php echo $Qslips->getBatchPageLinks('page', 'orders=list_credit_slips'); ?></span>
