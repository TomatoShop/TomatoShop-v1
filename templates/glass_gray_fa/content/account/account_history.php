...
<div class="moduleBox">
  ...
  <h6><span style="float: left;"><?php echo $osC_Language->get('order_status') . ' ' . osC_Order::getLastPublicStatus($Qhistory->value('orders_id')); ?></span><?php echo $osC_Language->get('order_number') . ' ' . $Qhistory->valueInt('orders_id'); ?></h6>
...
<div class="listingPageLinks">
  <span style="float: left;"><?php echo $Qhistory->getBatchPageLinks('page', 'orders'); ?></span>
