...
?>
        ...
        echo '&nbsp;' .$osC_Language->get('top_category');
        ...
        <td valign="top" align="left"><?php echo '<b>' . $osC_Currencies->displayPrice($products['final_price'], $products['tax_class_id'], $products['quantity']) . '</b>'; ?></td>
      </tr>
  ...
  //      foreach ($osC_OrderTotal->getResult() as $module) {
        foreach ($osC_ShoppingCart->getOrderTotals() as $module) {
          echo '    <tr>' . "\n" .
               ...
               '      <td align="left" width="100">' . $module['text'] . '&nbsp;</td>' . "\n" .
               '    </tr>';
        }
  //    }
  ?>
...
<div class="submitFormButtons">
  <span style="float: left;"><?php echo osc_link_object(osc_href_link(FILENAME_CHECKOUT, 'checkout', 'SSL'), osc_draw_image_button('button_checkout.gif', $osC_Language->get('button_checkout'))); ?></span>
  ...
  ?>
    ...
    <div align="left">
      <p align="left"><?php echo $osC_Language->get('alternative_checkout_methods'); ?></p>
