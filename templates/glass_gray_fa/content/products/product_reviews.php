...
<h1 style="float: left;"><?php echo $osC_Product->getPriceFormated(true); ?></h1>
...
<hr style="height: 1px; width: 95%; text-align: right; margin-right: 0px" />
...
?>
    ...
    <span style="float: left;"><?php echo osc_link_object(osc_href_link(FILENAME_PRODUCTS, 'reviews=new&' . $osC_Product->getID()), osc_draw_image_button('button_write_review.gif', $osC_Language->get('button_write_review'))); ?></span>
