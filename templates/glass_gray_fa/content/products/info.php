...
<div class="moduleBox">
  ...
  <div class="content">
    <div style="float: right;">
      ...
      <?php
        ...
        foreach ($images as $image){
          echo osc_link_object($osC_Image->getImageUrl($image['image'], 'large'), $osC_Image->show($image['image'], $osC_Product->getTitle(), '', 'mini'), 'rel="milkbox:group_products" product-info-img="' . $osC_Image->getImageUrl($image['image'], 'product_info') . '" large-img="' . $osC_Image->getImageUrl($image['image'], 'large') . '" style="float:right" class="mini"') . "\n";
        }
      ?>
      </div>
    </div>
    ...
    <table id="productInfo" border="0" cellspacing="0" cellpadding="2" style="float: left; width: 270px">
  ...
  ?>
      <tr>      
        ...
        <td><?php echo osc_draw_input_field('gift_certificate_amount', round($osC_Product->getOpenAmountMinValue(), $osC_Currencies->currencies[DEFAULT_CURRENCY]['decimal_places']), 'size="18"  dir="ltr"'); ?></td>
      </tr>
  <?php
    }
  ?>
  ...
  ?>
      <tr>
        ...
        <td><?php echo osc_draw_input_field('senders_email', null, 'size="18" dir="ltr"'); ?></td>
      </tr>
  <?php
    }
  ?>        
  ...
  ?>  
      <tr>      
        ...
        <td><?php echo osc_draw_input_field('recipients_email', null, 'size="18" dir="ltr"'); ?></td>
      </tr>
  <?php
    }
  ?>
  ...
  <?php 
   ...
   ?>
      ...
      <tr>
        <td colspan="2" align="right" valign="top" style="padding-top: 15px" id="shoppingCart">
          <?php
            echo '<b>' . $osC_Language->get('field_short_quantity') . '</b>&nbsp;' . osc_draw_input_field('quantity', $osC_Product->getMOQ(), 'size="3" dir="ltr"') . '&nbsp;' . osc_draw_image_submit_button('button_in_cart.gif', $osC_Language->get('button_add_to_cart'), 'style="vertical-align:middle;" class="ajaxAddToCart" id="ac_productsinfo_' . osc_get_product_id($osC_Product->getID()) . '"');
          ?>
        </td>
      </tr>
          ...
          <div class="content">
            ...
            ?>
                <dl class="review">
                  <?php
                    ...
                    echo '<p>' . nl2br($Qreviews->valueProtected('reviews_text')) . '</p>';
                    echo '</dd>'; 
                  ?>
                </dl>
            <?php
            ...
            ?>
              ...
              ?>
                ...
                ?>
				<div class="clearfix captcha" style="height:130px !important;">
				<table width="200" border="0">
				  <tr>
					<td>&nbsp;</td>
					<td><?php echo osc_image(osc_href_link(FILENAME_PRODUCTS, 'reviews=show_captcha', 'AUTO', true, false), $osC_Language->get('captcha_image_title'), 215, 80, 'id="captcha-code"'); ?></td>
					<td>&nbsp;</td>
				  </tr>
				<tr>
				  <td class="clearfix"><strong><?php echo osc_draw_label($osC_Language->get('enter_captcha_code'), 'captcha_code', null, true); ?></strong></td>
