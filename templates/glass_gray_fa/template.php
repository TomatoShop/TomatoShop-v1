...
*/
  ...
  class osC_Template_glass_gray_fa extends osC_TemplateInfo {
    var $_id,
        $_title = 'TomatoCart Persian Glass Gray',
        $_code = 'glass_gray_fa',
        $_author_name = 'TomatoShop Group',
        $_author_www = 'http://www.tomatoshop.ir',
    ...
    function install() {
      ...
      $data = array('categories' => array('*', 'right', '100'),
                    'manufacturers' => array('*', 'right', '200'),
                    'information' => array('*', 'right', '300'),
                    'whats_new' => array('*', 'left', '100'),
                    'manufacturer_info' => array('products/info', 'left', '200'),
                    'order_history' => array('*', 'left', '300'),
                    'best_sellers' => array('*', 'left', '400'),
                    'product_notifications' => array('products/info', 'left', '500'),
                    'tell_a_friend' => array('products/info', 'left', '600'),
                    'specials' => array('*', 'left', '700'),
