    ...
    <div id="pageContent">
      ...
      <div class="content">
        ...
        <form name="login" action="<?php echo osc_href_link(FILENAME_DEFAULT, 'maintenance=login', 'SSL'); ?>" method="post">
          ...
          <ol>
            <li><?php echo osc_draw_label($osC_Language->get('field_username'), 'user_name') . osc_draw_input_field('user_name',null,'dir="ltr"'); ?></li>
            <li><?php echo osc_draw_label($osC_Language->get('field_password'), 'user_password') . osc_draw_password_field('user_password','dir="ltr"'); ?></li>
          </ol>
